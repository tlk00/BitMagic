...
void Demo1(){
    ...
    bm::sparse_vector_float_serial_layout<bm::sparse_vector_float<bm::bvector<>>> layout1;
    ...
    */
    ...
    svf2.optimize(tb);
    bm::sparse_vector_float_serial_layout<bm::sparse_vector_float<bm::bvector<>>> layout2;
    ...
    bm::sparse_vector_float_deserializer<bm::sparse_vector_float<bm::bvector<>>> svfD;
    bm::sparse_vector_float<bm::bvector<>> svf2_restored;
    ...
    bm::sparse_vector_float<bm::bvector<>> svf2_masked;
...
void Demo2(){
    ...
    bm::sparse_vector_float<bm::bvector<>>::const_iterator itBegin = svf1.begin();
    ...
    // of the same svf
    bm::sparse_vector_float<bm::bvector<>>::const_iterator itA = svf1.begin();
    bm::sparse_vector_float<bm::bvector<>>::const_iterator itB = svf1.begin();
