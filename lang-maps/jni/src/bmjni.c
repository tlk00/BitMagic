 ...
 * Signature: (JJZZ)Z
 */
JNIEXPORT jboolean JNICALL Java_io_bitmagic_BVector0_setConditional0
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_flip0
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_setAll0
(JNIEnv *env, jclass obj, jlong ptr) {
 ...
 * Signature: (JJJZ)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_setRange0
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_invert0
(JNIEnv *env, jclass obj, jlong ptr) {
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_clear0
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_io_bitmagic_BVector0_extract0
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_io_bitmagic_BVector0_count0
(JNIEnv *env, jclass obj, jlong ptr) {
  unsigned int count;
 ...
 * Signature: (JJJ)J
 */
JNIEXPORT jlong JNICALL Java_io_bitmagic_BVector0_countInRange0
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_io_bitmagic_BVector0_nonEmpty0
(JNIEnv *env, jclass obj, jlong ptr) {
  int val;
 ...
 * Signature: (JJ)I
 */
JNIEXPORT jint JNICALL Java_io_bitmagic_BVector0_compare0
 ...
 */
JNIEXPORT jobject JNICALL Java_io_bitmagic_BVector0_optimize0
(JNIEnv *env, jclass obj, jlong ptr, jint opt_mode) {
  ...
  cls = (*env)->FindClass(env, "io/bitmagic/BitVectorStat");
 ...
 */
JNIEXPORT jobject JNICALL Java_io_bitmagic_BVector0_calcStat0
(JNIEnv *env, jclass obj, jlong ptr) {
  struct BM_bvector_statistics stat;
  jobject object;
  jmethodID constructor;
 ...
 * Signature: (JJI)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_operation0
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_and0
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_or0
(JNIEnv *env, jclass obj, jlong dst, jlong src) {
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_sub0
(JNIEnv *env, jclass obj, jlong dst, jlong src) {
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_io_bitmagic_BVector0_xor0
(JNIEnv *env, jclass obj, jlong dst, jlong src) {
