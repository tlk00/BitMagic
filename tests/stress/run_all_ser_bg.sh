...
./stress_release -ser 2>&1 > release.log &
PID_release=$!

./stress_release_gcc -ser 2>&1 > release_gcc.log &
PID_release_gcc=$!

./stress_release_sse2 -ser 2>&1 > release_sse2.log &
PID_release_sse2=$!

./stress_release_sse42 -ser 2>&1 > release_sse42.log &
PID_release_sse42=$!

./stress_release_avx2 -ser 2>&1 > release_avx2.log &
PID_release_avx2=$!
